...
🌐 Desenvolvimento Web:
Já tive a oportunidade de desenvolver um projeto com React e JavaScript no front-end, e Node.js e Express no back-end. Foi o primeiro projeto em que participei de todo o desenvolvimento, tanto no back-end quanto no front-end.

📱 Desenvolvimento Mobile:
Tenho experiência em React Native, onde desenvolvi um aplicativo móvel em equipe.
